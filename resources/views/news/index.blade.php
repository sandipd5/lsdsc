          ...
          <header>
            <div class="top-header">
             ...
             <div class="low-header" style="margin-top: -10px">
              ...
              <div class="events_image" style="background-image: url('/images/work/13.jpg')">
              ...
              <div class="container">
                <section class="projects row clearfix">
                  <div class="projects__content-wrapper text-center">
                    <div class="projects__content p-40">
                          ...
                          <div class="projects__box">
                            ...
                            <div class="project-desc">
                              ...
                              <div class="text-right clearfix">
                                <a href="{{ route('news.show',$post->id) }}" class="more">Full Story <i class="fa fa-angle-right"></i></a>
                              </div>
                            </div>
                          </div>
                        </div>
